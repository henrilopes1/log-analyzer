...
class PerformanceLogger:
    ...
    def log_function_call(self, function_name: str, duration_ms: float, 
...
class BusinessLogger:
    ...
    def log_analysis_completed(self, file_name: str, duration_ms: float,
    ...
    def log_threat_detected(self, threat_type: str, severity: str,
        ...
        message = f"Threat detected: {threat_type} ({severity}) from {source_ip or 'unknown'}"
...
def setup_structured_logging(name: str = 'log_analyzer',
                           level: str = 'INFO',
