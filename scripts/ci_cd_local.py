...
def install_dev_dependencies():
    ...
    console.print("[bold blue]📦 Instalando dependências de desenvolvimento...[/bold blue]")
...
def run_tests():
    ...
    test_commands = [
        ...
        ("python -m pytest tests/ --cov=src --cov-report=xml --cov-report=html --cov-fail-under=80", "Testes com cobertura"),
    ]
...
def run_linting():
    ...
    lint_commands = [
        ...
        ("python -m flake8 src/ --max-line-length=88 --extend-ignore=E203,E501,W503", "Flake8 linting"),
    ]
...
def run_security_checks():
    ...
    for cmd, desc in security_commands:
        ...
        if not success:
            ...
            console.print(f"[yellow]Warning:[/yellow] {desc} encontrou problemas, mas continuando...")
